...
(function () {
  ...
  const ASSETS = {
    ...
    revenueTrend:
      "https://raw.githubusercontent.com/MrPhilphiliberto/assets/main/descriptor_trend.png",
    revenueByRegion:
      "https://raw.githubusercontent.com/MrPhilphiliberto/assets/main/descriptor_bars.png",
    spendPerConversionTrend:
      "https://raw.githubusercontent.com/MrPhilphiliberto/assets/main/descriptor_efficiency_metric.png",
    // CSV upload preview screenshot (corrected URL)
    csvPreview:
      "https://raw.githubusercontent.com/MrPhilphiliberto/assets/main/descriptor_csv_preview.png",
  };
  ...
  const SCRIPT = [
    {
      ...
      ts: "2:06 PM",
      text:
        '<span class="mention">@Carlos – Dark Wave</span> how is Search performing in terms of revenue, as of late?',
      file: {
        ...
        note: "Click to expand inline (2,000+ rows)",
      },
      // 👀 → ⏳ → ✅ flow for the multi-demo wrapper
      reactions: ["eyes", "hourglass_flowing_sand", "white_check_mark"],
      // Slack-style CSV upload screenshot
      attachments: [
        {
          url: ASSETS.csvPreview,
          caption: "digital_performance_sept_2025.csv — Slack preview",
        },
      ],
    },

    {
      ...
      type: "controls",
      text:
        "Descriptor controls — open the modal to set grouping, target metric, and filters",
      controls: {
        primary: "Controls",
...

    {
      ...
      type: "summary",
      text:
        '<span class="pill pill-descriptor">📊 Performance Descriptor</span><br>' +
        ...
        "🧠 <strong>Summary:</strong> In the last 7 days ending September 16, 2025, revenue reached $9.2K, significantly higher than the 2-week moving average of $5.6K, marking a substantial increase of +63.8%. Compared to the 4-week moving average of $7.3K, this represents a +26.1% improvement, and it is also +11.5% above the 8-week moving average of $8.2K. Month-to-date, revenue stands at $20.4K, which is slightly below the 1-month aligned moving average of $20.5K by -0.6%, but up +2.0% compared to the 3-month aligned average of $20.0K. The projected revenue for the month is $38.2K, which is -4.8% lower than the 1-month moving average of $40.1K but +16.7% higher than the 6-month average of $32.7K. Currently, the efficiency metric for spend per conversion is $353, which is better than the mean of $370 and the median of $369. The top revenue regions are US at $10.7K, EU at $9.6K, and APAC at $7.2K.<br><br>" +
        "📅 <strong>Recent (last 7 days ending 2025-09-16):</strong><br>" +
        "– revenue: <strong>$9.2K</strong><br>" +
        "&nbsp;&nbsp;↳ vs 2W MA: <strong>$5.6K</strong> (↑ 63.8%)<br>" +
        "&nbsp;&nbsp;↳ vs 4W MA: <strong>$7.3K</strong> (↑ 26.1%)<br>" +
        "&nbsp;&nbsp;↳ vs 8W MA: <strong>$8.2K</strong> (↑ 11.5%)<br><br>" +
        "🗓️ <strong>Month-to-Date (through 2025-09-16):</strong><br>" +
        "– Projected month: <strong>$38.2K</strong><br>" +
        "&nbsp;&nbsp;↳ vs 1M MA: <strong>$40.1K</strong> (↓ -4.8%)<br>" +
        "&nbsp;&nbsp;↳ vs 3M MA: <strong>$39.4K</strong> (↓ -3.0%)<br>" +
        "&nbsp;&nbsp;↳ vs 6M MA: <strong>$32.7K</strong> (↑ +16.7%)<br><br>" +
        "💡 <strong>Top region this period:</strong><br>" +
        "&nbsp;&nbsp;↳ US: <strong>$10.7K</strong><br>" +
        "&nbsp;&nbsp;↳ EU: <strong>$9.6K</strong><br>" +
        "&nbsp;&nbsp;↳ APAC: <strong>$7.2K</strong>",
    },
      ...
      attachments: [
        {
          ...
          caption:
            "Spend per conversion trend (weekly) with moving averages",
        },
      ],
    },
  ];
