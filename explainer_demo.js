...
(function () {
  ...
  const SCRIPT = [
    {
      ...
      ts: "11:02 AM",
      text:
        '<span class="mention">@Carlos – Dark Wave</span> can you identify the key drivers of Cart Adds?',
      file: {
...

    {
      ...
      type: "controls",
      text:
        "Explainer — Controls  ·  adjust settings or export<br>" +
        "Carlos: p=15, n=550 (p/n=0.03). Cap=55. Grain=keep; Panel=None.",
      controls: {
        primary: "Controls",
...

    {
      ...
      type: "summary",
      text:
        "🧠 Explainer Summary<br>" +
        "The primary driver boosting Cart Adds is CPI_YoY, while MacroCostIndex is exerting a negative influence. Models agree on the importance of Spend, MacroCostIndex, and MacroDemandIndex, with no unique features identified in the random forest or lasso models. The compact OLS results indicate that an increase in Spend leads to a significant rise in Cart Adds, while higher MacroCostIndex negatively impacts it. Elasticity analysis shows that Spend has the highest positive elasticity at 0.97, indicating a strong responsiveness, while MacroCostIndex has a negative elasticity of -0.16. The random forest model has an R² of 0.358, while the lasso model is slightly better at 0.377, suggesting a moderate fit. The residual correlation of +0.25 indicates some relationship between the predicted and actual values, but there is room for improvement in the model's predictive power.",
    },

    {
      ...
      attachments: [
        {
          url: ASSETS.rfImportance,
          caption: "Random Forest importance (holdout PI)",
        },
      ],
    },
...

    {
      ...
      attachments: [
        {
          url: ASSETS.elasticities,
          caption: "Elasticities (preferred: log-log)",
        },
      ],
    },

    {
      ...
      attachments: [
        {
          url: ASSETS.coefs,
          caption: "Compact model — signed driver effects",
        },
      ],
    },
  ];
  ...
  window.DWMS_DEMO_REGISTRY.explainer = {
    id: "explainer",
    tabLabel: "Driver Identification",
    channel: "#carlos",
    participants: {
      nora: {
        displayName: "Nora C.",
